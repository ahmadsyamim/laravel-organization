...
<body class="bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-8">
                    <h1 class="text-xl font-semibold text-gray-900">Laravel Organization</h1>
                    <div class="hidden sm:flex space-x-1">
                        <a href="{{ route('dashboard') }}"
                            class="px-3 py-2 rounded-md text-sm font-medium bg-blue-100 text-blue-900">
                            Dashboard
                        </a>
                        <a href="{{ route('invitations') }}"
                            class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 transition">
                            Invitations
                        </a>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 mt-4 lg:px-8 space-y-4">
        ...
        @livewire('org::create')
        @livewire('org::update')
        @livewire('org::transfer-ownership')
    </div>
